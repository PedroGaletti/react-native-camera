...
#import <UIKit/UIKit.h>
  ...
  typedef NS_ENUM(NSInteger, RNFaceDetectionContours) {
      RNFaceDetectAllContours = FIRVisionFaceDetectorContourModeAll,
      RNFaceDetectNoContours = FIRVisionFaceDetectorContourModeNone
  };
